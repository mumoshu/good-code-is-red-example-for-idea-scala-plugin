...
Asssume that there are two jars(or modules) __framework__ and __framework_extension__,
and you first defined type 'DefaultController' in __framework__.

You can redefine 'DefaultController' in __framework__, using package objects.
